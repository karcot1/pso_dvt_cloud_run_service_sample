...
#     source_type = os.environ.get("SOURCE_DB")
#     print("source: " + source_type)

#     target_type = os.environ.get["TARGET_DB"]
#     print("target: " + target_type)

#     bq_project_id = os.environ.get("PROJECT_ID")
#     print("project_id: " + bq_project_id)
...
#     subprocess.call(['bash', "./execute_dvt_partition_yamls.sh", yaml_fullpath, bq_project_id, source_type, target_type])
